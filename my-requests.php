...
require_login();
apply_rating_timeouts((int)current_user_id());
...
<head>
  ...
  <title>UniBite - My Requests</title>
...
<main class="container request-page">
  <div class="page-head">
    <div>
      <p class="eyebrow">Outgoing requests</p>
      <h1>My requests</h1>
      <p class="text-muted">Track the requests you have sent and their current status.</p>
    </div>
    <div class="request-page__switch">
      <a class="btn btn--ghost" href="/requests.php">Incoming requests</a>
    </div>
  </div>

  <p id="requests-msg" class="msg" hidden></p>
  <section class="request-list card" id="requests-list" data-request-scope="outgoing"></section>
</main>

<script>
  window.UNIBITE_REQUEST_PAGE = 'outgoing';
</script>
